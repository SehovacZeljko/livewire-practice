                ...
                <div class="text-center">
                    <div class="mx-5 px-5 wow fadeInDown">
                        <div class="relative inline-block px-16 lg:px-24">
                            ...
                            <h1 class="text-6xl md:text-7xl lg:text-8xl font-bold uppercase text-white mb-6">Modeling
                                Agency</h1>
                    ...
                    <a href="/about" wire:navigate
                        class="inline-block bg-primary text-dark font-bold uppercase tracking-wider border-2 border-primary py-3 px-8 transition-all duration-300 hover:bg-transparent hover:text-primary wow fadeInUp"
                        data-wow-delay="0.4s">
                        Explore More
                    </a>
                </div>
    ...
    <div class="w-full py-12 md:py-20 bg-secondary">
        <div class="max-w-7xl mx-auto px-4 py-12 md:py-20">
            <div class="text-center wow fadeInUp" data-wow-delay="0.3s">
                <div
                    class="max-w-2xl mx-auto bg-[#111111] p-8 lg:p-12 border border-gray-800 transition-all duration-300 hover:border-primary">
                    ...
                    <div class="flex items-center justify-center border-t border-gray-800 pt-6">
                        <img class="w-12 h-12 rounded-full object-cover border-2 border-primary"
                            src="{{ asset('img/testimonial-1.jpg') }}" alt="Joanne Irwin">
                        <div class="ml-4">
    ...
    <div class="w-full py-12 md:py-20 bg-secondary">
        <div class="max-w-7xl mx-auto px-4 py-12 md:py-20">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 justify-items-center">
                {{-- Card 1 --}}
                <x-testimonial-card image="img/testimonial-1.jpg" name="Joanne Irwin" profession="Fashion Designer"
                    delay="0.1s">
                    The talent at Poseify is exceptional. They provided the perfect models for our runway show, and the
                    communication was professional from start to finish.
                </x-testimonial-card>

                {{-- Card 2 --}}
                <x-testimonial-card image="img/testimonial-2.jpg" name="Lana Anderson" profession="Photographer"
                    delay="0.3s">
                    As a photographer, I value models who know how to move. Every model we've booked through this agency
                    has been top-tier and highly experienced.
                </x-testimonial-card>

                {{-- Card 3 --}}
                <x-testimonial-card image="img/testimonial-3.jpg" name="Pamela Torney" profession="Marketing Lead"
                    delay="0.5s">
                    Poseify makes casting so easy. Their digital portfolios are accurate and the booking process is
                    faster than any other agency we've used.
                </x-testimonial-card>
            </div>
        </div>
    </div>
